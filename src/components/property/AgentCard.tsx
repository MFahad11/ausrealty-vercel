    ...
    <div key={index} className="bg-white border border-darkgray rounded-md shadow-md">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {
                    showLinks ? (<><div className="flex items-center justify-center gap-4 pt-4 border-t">
                  {agent.facebookUrl && (
                ...
                </div></>):(<><div className="flex items-center justify-between px-4 py-2 border-t border-b">
